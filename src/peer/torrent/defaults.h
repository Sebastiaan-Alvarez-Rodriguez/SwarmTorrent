...
namespace peer::torrent::defaults {
    ...
    constexpr const uint16_t prefered_group_size = 5; //amount of peers we would like to have in our group
    constexpr const uint16_t prefered_known_peers_size = 20; // amount of peers we want to know about
